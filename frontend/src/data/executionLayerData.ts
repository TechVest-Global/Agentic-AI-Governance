...
export const runtimeEvents: RuntimeEvent[] = [
  ...
  { id: "re-03", timestamp: "09:15:33", message: "Probe budget allocated — 6 agents activated", layer: "Orchestrator Planning", type: "info" },
...
export const architectureNodes: ArchitectureNode[] = [
  { id: "frontend", name: "Frontend", description: "React UI — governance control plane interface", active: true },
  ...
  { id: "agents", name: "Specialist Agents", description: "6 concurrent agents executing probes", active: true },
...
export const agentRuntimeDetails: AgentRuntimeDetail[] = [
  {
    ...
    phases: [
      { phase: "Inputs Read", status: "complete", detail: "Loaded system profile, context package, probe budget (50 probes)", duration: "2s" },
      { phase: "Probe Design", status: "complete", detail: "Generated 50 controlled pair probes across age, gender, ethnicity", duration: "8s" },
      { phase: "Probe Execution", status: "running", detail: "48/50 probes executed — persistent disparity signal from probe 24", duration: "4m 12s" },
      { phase: "Metric Calculation", status: "running", detail: "Running: sentiment delta, disparate impact ratio, statistical significance", duration: "—" },
      { phase: "Framework Mapping", status: "waiting", detail: "Will map to EU AI Act Art.10(2)(f) and SR 11-7 §4.1" },
      { phase: "Finding Emission", status: "waiting", detail: "F-001 emitted — awaiting final confidence score from council" },
      { phase: "Handoff to Evidence Aggregator", status: "waiting", detail: "Bundle ready — waiting for join barrier" },
    ],
  },
  {
    ...
    phases: [
      { phase: "Inputs Read", status: "complete", detail: "Loaded baseline v4.0 responses and benchmark prompt set", duration: "3s" },
      ...
      { phase: "Metric Calculation", status: "running", detail: "Computing: semantic similarity, KL-divergence, explanation consistency", duration: "—" },
      { phase: "Framework Mapping", status: "waiting", detail: "Will map to NIST AI RMF Measure 2.5, ISO 42001 §9.1" },
      { phase: "Finding Emission", status: "waiting", detail: "F-002 emitted — semantic drift confirmed below threshold" },
      { phase: "Handoff to Evidence Aggregator", status: "waiting", detail: "Bundle ready — waiting for join barrier" },
    ],
  },
  {
    ...
    phases: [
      { phase: "Inputs Read", status: "complete", detail: "Loaded OWASP and MITRE attack libraries", duration: "1s" },
      ...
      { phase: "Metric Calculation", status: "complete", detail: "Computed boundary hold rate, injection resistance, leakage score", duration: "4s" },
      { phase: "Framework Mapping", status: "complete", detail: "Mapped to OWASP LLM Top 10, MITRE ATLAS", duration: "2s" },
      { phase: "Finding Emission", status: "complete", detail: "No findings emitted — clean result", duration: "1s" },
      { phase: "Handoff to Evidence Aggregator", status: "complete", detail: "Clean bundle delivered to aggregator", duration: "1s" },
    ],
  },
  {
    ...
    phases: [
      { phase: "Inputs Read", status: "complete", detail: "Loaded framework requirements and current documentation state", duration: "4s" },
      ...
      { phase: "Metric Calculation", status: "running", detail: "Computing: completeness scores, correlation metrics", duration: "—" },
      { phase: "Framework Mapping", status: "running", detail: "Mapping evidence to specific clause requirements" },
      { phase: "Finding Emission", status: "complete", detail: "F-003 emitted — documentation incomplete", duration: "1s" },
      { phase: "Handoff to Evidence Aggregator", status: "waiting", detail: "Awaiting final 2 probes before bundle handoff" },
    ],
  },
  {
    ...
    phases: [
      { phase: "Inputs Read", status: "complete", detail: "Loaded explanation outputs and SHAP baseline", duration: "3s" },
      { phase: "Probe Design", status: "complete", detail: "Designed 20 explanation probes — 7 in first batch", duration: "5s" },
      { phase: "Probe Execution", status: "running", detail: "7/20 probes complete — debt ratio underexplained signal", duration: "2m 45s" },
      { phase: "Metric Calculation", status: "running", detail: "Computing: faithfulness, attribution alignment, consistency", duration: "—" },
      { phase: "Framework Mapping", status: "waiting", detail: "Will map to EU AI Act Art.13, NIST AI RMF" },
      { phase: "Finding Emission", status: "waiting", detail: "No formal finding yet — early signal pending confirmation" },
      { phase: "Handoff to Evidence Aggregator", status: "waiting", detail: "Partial bundle — awaiting remaining 13 probes" },
    ],
  },
  {
    agentId: "risk-scorer",
    ...
    phases: [
      { phase: "Inputs Read", status: "waiting", detail: "Waiting for all specialist agents to complete" },
      ...
      { phase: "Metric Calculation", status: "waiting", detail: "Will compute composite score after join barrier" },
      { phase: "Framework Mapping", status: "waiting", detail: "Will map to Internal Governance Policy" },
      { phase: "Finding Emission", status: "waiting", detail: "Will emit tier recommendation to verdict agent" },
      { phase: "Handoff to Evidence Aggregator", status: "waiting", detail: "Final agent in chain — hands off to council" },
    ],
  },
];
