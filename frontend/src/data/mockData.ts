...
export const navigation: NavigationItem[] = [
  ...
  { id: "runs", label: "Governance Workflow", section: "Govern", path: "/runs", icon: Activity, personas: ["auditor", "developer"], hiddenFor: ["developer"] },
  { id: "eval-runs", label: "Run History", section: "Govern", path: "/eval-runs", icon: ListChecks, personas: ["auditor", "developer"] },
  { id: "engine", label: "Developer Workspace", section: "Govern", path: "/engine", icon: Cpu, personas: ["developer"] },
  // Folded into the Governance Workflow as expandable layers + side-drawers.
  // Kept routable (hidden) so deep links and in-workflow drawers still resolve.
  { id: "agents", label: "Agent Intelligence", section: "Govern", path: "/agents", icon: Bot, personas: ["developer"], hidden: true },
  { id: "metric-plan", label: "Metric Plan", section: "Govern", path: "/metric-plan", icon: ClipboardList, personas: ["developer"], hidden: true },
  ...
  // Folded into the Governance Workflow (verdict layer, evidence + ledger drawers).
  { id: "verdicts", label: "Verdicts", section: "Assurance", path: "/verdicts", icon: GitBranch, personas: ["auditor", "developer"], hidden: true },
  { id: "evidence", label: "Evidence", section: "Assurance", path: "/evidence", icon: FileSearch, personas: ["auditor", "developer"], hidden: true },
  { id: "ledger", label: "Audit Ledger", section: "Assurance", path: "/ledger", icon: BookOpen, personas: ["auditor", "developer"], hidden: true },
  // ── Configure (developer only) ────────────────────────────────────────
  { id: "system-setup", label: "AI System Setup", section: "Configure", path: "/system-setup", icon: Settings, personas: ["developer"], hidden: true },
  { id: "context-profiles", label: "Context Profiles", section: "Configure", path: "/context-profiles", icon: Layers, personas: ["developer"], hidden: true },
  { id: "capabilities", label: "Capabilities", section: "Configure", path: "/capabilities", icon: Boxes, personas: ["developer"], hidden: true },
  { id: "metrics-config", label: "Metrics Configuration", section: "Configure", path: "/metrics-config", icon: SlidersHorizontal, personas: ["developer"], hidden: true },
  { id: "framework-mapping", label: "Framework Mapping", section: "Configure", path: "/framework-mapping", icon: Network, personas: ["developer"], hidden: true },
  { id: "llm-boundary", label: "LLM Client Boundary", section: "Configure", path: "/llm-boundary", icon: Split, personas: ["developer"], hidden: true },
  { id: "security-tools", label: "Security Tools", section: "Configure", path: "/security-tools", icon: Bug, personas: ["developer"], hidden: true },
  // ── Operate (developer only) ──────────────────────────────────────────
  { id: "governance-state", label: "Governance State", section: "Operate", path: "/governance-state", icon: Database, personas: ["developer"], hidden: true },
  { id: "api-debug", label: "API Debug", section: "Operate", path: "/api-debug", icon: Terminal, personas: ["developer"], hidden: true },
];
